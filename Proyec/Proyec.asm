...
BOOL_V_IMG DB 0
BOOL_GUARDAR DB 0
MSJ_NOCLICK DB 0dh,' NO CLICK', '$'
MSJ_INI DB 0dh,' BIENDVENIDO ', '$'
MSJ_FELICIDADES DB 0AH,0dh,' FELICIDADES ', '$'
MSJ_CLICK DB 0dh,' CLICK$', '$'
...
;TIGRE DB 'C:\IMAGENES\TIGRE1.IER', 0
...
MAIN PROC FAR
	...
	CALL COPIARARCH
	MOV AH, 01H ;INTERRUPCION TECLADO
	INT 16H
